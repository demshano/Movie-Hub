...
import backupImage from '../images/backupImage.jpg';
...
useEffect(()=>{
  async function fetchMovie(){
    const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=a65a50fa7876b631c58b24400a9b4b7f`);
        ...
        <p className='my-4'>{movie.overview}</p>
          ...
          <div className="flex items-center">
            ...
            <span className='mr-2 font-bold'>IMDB Code:</span>
              <a href={`http://www.imdb.com/title/${movie.imdb_id}`} target='_blank' rel='noreferrer'>{movie.imdb_id}</a>
            </p>
